...
agregarverbo n palabras 
    |n == 1 = do
        ...
        putStrLn "Ustedes: " 
        el19 <- getLine
        let verbonos = el1 ++ " " ++ el2 ++  " " ++ el3 ++  " " ++ el4 ++  " " ++ el5 ++  " " ++ el6 ++  " " ++ el7 ++  " " ++ el8 ++  " " ++ el9 ++  " " ++ el10 ++  " " ++ el11 ++  " " ++ el12 ++  " " ++ el13 ++ " " ++  el14 ++ " " ++  el15 ++ " " ++  el16 ++  " " ++ el17 ++ " " ++  el18 ++  " " ++ el19   --el proposito final será agregar un nuevo verbo o corregir uno de los verbos ya existentes
